function openModal(e){let t=document.getElementById(e),l=t.querySelector("img").src,n=l.substring(l.lastIndexOf("/")+1),a=t.querySelector(".card-title").innerText,o=t.querySelector(".card-text").innerText,b=t.querySelector(".shape").innerText,r=`مرحبًا، أرغب في حجز هذا العنصر:
